...
'''
    1. result gets encrypted_1 by key and query at index.
    2. result gets encrypted_2 by key and query at index.
    3. result gets printed.

    idea: use result to go backwards and decrpyt the key
    note: guess is only 4 bytes!
'''
